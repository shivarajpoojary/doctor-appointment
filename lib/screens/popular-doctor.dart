...
import 'package:doctor_appointment/screens/detail-view.dart';
import 'package:flutter/material.dart';

class PopularDoctor extends StatefulWidget {
  PopularDoctor({Key? key}) : super(key: key);

  @override
  _MessageState createState() => _MessageState();
}

class _MessageState extends State<PopularDoctor> {
  late Database db;
  List docs = [];
  initialise() {
    db = Database();
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          DetailedView(doctor: docs[index], db: db),
                    ),
                  ).then((value) => {
